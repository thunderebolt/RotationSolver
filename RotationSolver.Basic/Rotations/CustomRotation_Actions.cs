...
public abstract partial class CustomRotation {
  internal class RoleAction: BaseAction {
    ...
    internal RoleAction(ActionID actionID, JobRole[] roles, ActionOption option = ActionOption.None) : base(actionID, option) {
      _roles = roles;
    }
  ...
  /// 
  /// </summary>
  public static IBaseAction Addle {
    get;
  } = new RoleAction(ActionID.Addle, new JobRole[] {
    JobRole.RangedMagical
  },
  ActionOption.Defense) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Swiftcast {
    get;
  } = new RoleAction(ActionID.SwiftCast, new JobRole[] {
    JobRole.RangedMagical,
    JobRole.Healer
  },
  ActionOption.Buff) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Esuna {
    get;
  } = new RoleAction(ActionID.Esuna, new JobRole[] {
    JobRole.Healer
  },
  ActionOption.Heal) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Rescue {
    get;
  } = new RoleAction(ActionID.Rescue, new JobRole[] {
    JobRole.Healer
  },
  ActionOption.Heal);
  ...
  /// 
  /// </summary>
  public static IBaseAction Repose {
    get;
  } = new RoleAction(ActionID.Repose, new JobRole[] {
    JobRole.Healer
  });
  ...
  /// 
  /// </summary>
  public static IBaseAction LucidDreaming {
    get;
  } = new RoleAction(ActionID.LucidDreaming, new JobRole[] {
    JobRole.Healer,
    JobRole.RangedMagical
  },
  ActionOption.Buff) {
  ...
  /// 
  /// </summary>
  public static IBaseAction SecondWind {
    get;
  } = new RoleAction(ActionID.SecondWind, new JobRole[] {
  ...
  /// 
  /// </summary>
  public static IBaseAction ArmsLength {
    get;
  } = new RoleAction(ActionID.ArmsLength, new JobRole[] {
    JobRole.Tank,
    JobRole.Melee,
    JobRole.RangedPhysical
  },
  ...
  /// 
  /// </summary>
  public static IBaseAction Rampart {
    get;
  } = new RoleAction(ActionID.Rampart, new JobRole[] {
    JobRole.Tank
  },
  ActionOption.Defense) {
    StatusProvide = new StatusID[] {
  ...
  /// 
  /// </summary>
  public static IBaseAction Provoke {
    get;
  } = new RoleAction(ActionID.Provoke, new JobRole[] {
    JobRole.Tank
  }) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Reprisal {
    get;
  } = new RoleAction(ActionID.Reprisal, new JobRole[] {
    JobRole.Tank
  });
  ...
  /// 
  /// </summary>
  public static IBaseAction Shirk {
    get;
  } = new RoleAction(ActionID.Shirk, new JobRole[] {
    JobRole.Tank
  },
  ActionOption.Friendly) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Bloodbath {
    get;
  } = new RoleAction(ActionID.Bloodbath, new JobRole[] {
    JobRole.Melee
  },
  ActionOption.Heal) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Feint {
    get;
  } = new RoleAction(ActionID.Feint, new JobRole[] {
    JobRole.Melee
  },
  ActionOption.Defense) {
  ...
  /// 
  /// </summary>
  public static IBaseAction Interject {
    get;
  } = new RoleAction(ActionID.Interject, new JobRole[] {
    JobRole.Tank
  }) {
  ...
  /// 
  /// </summary>
  public static IBaseAction LowBlow {
    get;
  } = new RoleAction(ActionID.LowBlow, new JobRole[] {
    JobRole.Tank
  }) {
  ...
  /// 
  /// </summary>
  public static IBaseAction LegSweep {
    get;
  } = new RoleAction(ActionID.LegSweep, new JobRole[] {
    JobRole.Melee
  }) {
    FilterForHostiles = b =>b.Where(ObjectHelper.CanInterrupt),
  };
  ...
  /// 
  /// </summary>
  public static IBaseAction HeadGraze {
    get;
  } = new RoleAction(ActionID.HeadGraze, new JobRole[] {
    JobRole.RangedPhysical
  }) {
    FilterForHostiles = b =>b.Where(ObjectHelper.CanInterrupt),
  };
  ...
  /// 
  /// </summary>
  public static IBaseAction SureCast {
    get;
  } = new RoleAction(ActionID.SureCast, new JobRole[] {
    JobRole.RangedMagical,
    JobRole.Healer
  },
  ActionOption.Heal);
  ...
  /// 
  /// </summary>
  public static IBaseAction TrueNorth {
    get;
  } = new RoleAction(ActionID.TrueNorth, new JobRole[] {
    JobRole.Melee
  },
  ActionOption.Heal) {
    StatusProvide = new StatusID[] {
  ...
  /// 
  /// </summary>
  public static IBaseAction Peloton {
    get;
  } = new RoleAction(ActionID.Peloton, new JobRole[] {
    JobRole.RangedPhysical
  },
  ActionOption.Friendly) {
    ActionCheck = (b, m) =>NotInCombatDelay && PartyMembers.GetObjectInRadius(20).Any(p =>p.WillStatusEnd(3, false, StatusID.Peloton) && !p.StatusFlags.HasFlag(Dalamud.Game.ClientState.Objects.Enums.StatusFlags.InCombat)),
  };

  /// <summary>
  /// 
  /// </summary>
  public static IBaseAction Sprint {
    get;
  } = new BaseAction(ActionID.Sprint, ActionOption.Friendly);
